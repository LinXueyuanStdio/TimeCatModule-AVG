 ...
 * @date 2021/11/28
 * @description compose 实现渲染
 * @usage null
 */
class StoryComposeActivity : BaseSettingActivity() {
    ...
    val core = object : IEventCore {
        ...
        override fun getViewModelStore(): ViewModelStore {
            return this@StoryComposeActivity.viewModelStore
        }

        override fun getLifecycle(): Lifecycle {
            return this@StoryComposeActivity.lifecycle
        }
    }
