package com.timecat.module.vge.pokedroid.util;
...
public final class TextureUtils {
	 ...
	 */
	public static Animation<TextureRegion>[] createRMAnimation(TextureRegion t, float speed) {
	 ...
	 * @return The animations.
	 */
	public static Animation<TextureRegion>[] createRMAnimation(Texture t, float speed) {
		return createRMAnimation(splitTexture(t, 4, 4), speed);
	}
	 ...
	 * @return The animations.
	 */
	public static Animation<TextureRegion>[] createRMAnimation(TextureRegion[] regions, float speed) {
