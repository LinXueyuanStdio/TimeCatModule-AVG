package com.timecat.module.vge.pokedroid.entity;
...
import com.timecat.module.vge.pokedroid.util.TextureUtils;
...
public abstract class HumanEntity extends Entity {
	...
	public void render(Batch batch) {
		TextureRegion reg = (TextureRegion) moveAnims[lookDirection.ordinal()].getKeyFrame(animTime);
		batch.draw(reg,
