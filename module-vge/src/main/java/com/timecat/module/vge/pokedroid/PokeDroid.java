package com.timecat.module.vge.pokedroid;
...
import com.timecat.module.vge.pokedroid.input.OnscreenControls;
import com.timecat.module.vge.pokedroid.scene.Scene;
import com.timecat.module.vge.pokedroid.scene.SceneManager;
import com.timecat.module.vge.pokedroid.scene.SceneSplash;
import com.timecat.module.vge.pokedroid.story.Story;
...
public class PokeDroid extends ApplicationAdapter implements InputProcessor {
    ...
    public void create() {
        ...
        JsonValue stories = new JsonReader().parse(Gdx.files.internal("game/storylist.json"));
