...
namespace jsengine {
    ...
    struct JJSCallback : public JavaClass<JJSCallback> {
        constexpr static auto kJavaDescriptor = "Lcom/timecat/component/engine/js/JSCallback;";
    };

    class Bridge : public facebook::jni::HybridClass<Bridge> {
    public:
        static constexpr auto kJavaDescriptor = "Lcom/timecat/component/engine/js/Bridge;";
